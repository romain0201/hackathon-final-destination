 ...
 */
final class Version20240629192913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE symptom_user_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE symptom_user (id INT NOT NULL, symptom_id INT DEFAULT NULL, patient_id INT DEFAULT NULL, archived BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_8ECE5BA5DEEFDA95 ON symptom_user (symptom_id)');
        $this->addSql('CREATE INDEX IDX_8ECE5BA56B899279 ON symptom_user (patient_id)');
        ...
        $this->addSql('ALTER TABLE symptom_user ADD CONSTRAINT FK_8ECE5BA5DEEFDA95 FOREIGN KEY (symptom_id) REFERENCES symptom (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE symptom_user ADD CONSTRAINT FK_8ECE5BA56B899279 FOREIGN KEY (patient_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE symptom_user_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE symptom_user DROP CONSTRAINT FK_8ECE5BA56B899279');
