 ...
 */
final class Version20240624220610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT NOT NULL, author_id INT DEFAULT NULL, channel_id INT DEFAULT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
